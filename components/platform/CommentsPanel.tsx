...
import DesignWorkflowPartnerNotesPanel from "./DesignWorkflowPartnerNotesPanel";
...
export default function CommentsPanel({
  ...
  const showDesignWorkflowPartnerNotes = entityType === "design_workflow" && !!entityId;
  ...
  return (
    <>
      {showDesignWorkflowPartnerNotes ? (
        <DesignWorkflowPartnerNotesPanel requestId={entityId} />
      ) : null}
